...
import th.or.etda.xmlvalidator.model.response;
import th.or.etda.xmlvalidator.util.JsonUtil;
import th.or.etda.xmlvalidator.util.XMLUtil;
import th.or.etda.xmlvalidator.validator.Schema;
import th.or.etda.xmlvalidator.validator.Schematron;
    ...
    private void initValidateParameter() {
        ...
        for (Object obj : jsonArray) {
            ...
            if (e.equals(XMLRoot) && version.equals(versionChoosen)) {
                ...
                param.setSchemaPath(FilenameUtils.normalize(schemaPath));
                param.setSchematronPath(FilenameUtils.normalize(schematronPath));
